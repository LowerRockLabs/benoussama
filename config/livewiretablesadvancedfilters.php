    ...
    'numberRange' => [
        ...
        'styling' => [
            'light' => [ // Used When "dark" class is not in a parent element
                ...
                'fillColor' => '#A020F0', // The color of the bar for the selected range
                'primaryColor' => '#A020F0', // The primary color
                'progressBackground' => '#eee', // The color of the remainder of the bar
                'thumbColor' => '#FFFFFF', // The color of the Circle
                'ticksColor' => 'silver',
                'valueBg' => 'transparent',
                'valueBgHover' => '#A020F0', // The bg color of the current value when the relevant selector is hovered over
            ],
